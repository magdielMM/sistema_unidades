...
namespace sistema_unidades.Controllers
{
    public class TipoesController : Controller
    {
        ...
        public TipoesController(ClienteBdContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Tipos != null ? 
                          ...
                          Problem("Entity set 'ClienteBdContext.Tipos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ClienteBdContext.Tipos'  is null.");
            }
            var tipo = await _context.Tipos.FindAsync(id);
            if (tipo != null)
            {
